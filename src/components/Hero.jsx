      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="md:w-1/2 mb-10 md:mb-0 text-white">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">
            Hi, I'm <span className="text-purple-500">Durga Waghchaure</span>
          </h1>
...
<div className="absolute inset-0 rounded-full bg-gradiend-to-r from-purple to-pink
animation-pluse-slow opacity-70">
    <motion.img src="/src/assets/profile.avif" alt="profile"
